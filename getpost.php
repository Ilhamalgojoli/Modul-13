...
$sql = "SELECT post.id_post,post.post,post.created_at,users.fullname,users.id_user AS post_owner_id
(SELECT COUNT(*)FROM likes WHERE likes.id_post = posts.id_post) AS like_count FROM posts 
    ...
    <div class='box' id='content-container'>
        <div class='row'>
            ...
            <div class='col-md-11' style='padding-left:5px;'>
                ...
                <button onclick='likePost($post_id)' class = 'btn btn-primary btn-sm'>Like</button>
                <button onclick='unlikePost($post_id)' class = 'btn btn-primary btn-sm'>Unlike</button>";
